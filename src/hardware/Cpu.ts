...
export class Cpu extends Hardware implements ClockListener{
    ...
    //Program counter, IR, AC, Xreg, Yreg, Zflag, carryFlag, Cycle, import MMU, decodeStep, executeStep, import Ascii, import interrupt controller
    ...
    decodeStep: number = 1;
    executeStep: number = 1;
    private ascii = null;
    private interruptController: interruptController = null;
    
    constructor(id: number, name: string, mmu: MMU, interruptController: interruptController) {     
        super(0, 'CPU');
        this.mmu = mmu;
